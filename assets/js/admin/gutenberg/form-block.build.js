		...
		jsx = [wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(RadioControl, {
					...
					selected: formType,
					options: [{ label: 'Registration Form', value: 'registration_form' }, { label: 'Login Form', value: 'login_form' }],
					onChange: selectForm
				}),
				formType === 'registration_form' ? wp.element.createElement(SelectControl, {
					...
					key: 'ur-gutenberg-form-selector-select-control',
					selected: shortcode,
					options: [{ label: 'Select Shortcode', value: '' }, { label: 'Login Shortcode', value: 'login_shortcode' }, { label: 'My Account Shortcode', value: 'myaccount_shortcode' }],
