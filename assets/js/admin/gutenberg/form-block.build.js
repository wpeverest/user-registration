...
var UserRegistrationIcon = createElement("svg", {
  width: 24,
  height: 24,
  viewBox: "0 0 32 32"
}, createElement("path", {
...
registerBlockType("user-registration/form-selector", {
  ...
  edit: function edit(props) {
    var _props$attributes = props.attributes,
        ...
        formType = _props$attributes$for2 === void 0 ? "registration_form" : _props$attributes$for2,
        _props$attributes$sho = _props$attributes.shortcode,
        shortcode = _props$attributes$sho === void 0 ? "" : _props$attributes$sho,
        _props$attributes$red = _props$attributes.redirectUrl,
        redirectUrl = _props$attributes$red === void 0 ? "" : _props$attributes$red,
        _props$attributes$log = _props$attributes.logoutUrl,
        logoutUrl = _props$attributes$log === void 0 ? "" : _props$attributes$log,
    ...
    jsx = [wp.element.createElement(InspectorControls, {
    ...
    if (formId || "" !== shortcode) {
      ...
      jsx.push(wp.element.createElement(Placeholder, {
        key: "ur-gutenberg-form-selector-wrap",
        className: "ur-gutenberg-form-selector-wrap"
      }, wp.element.createElement("img", {
        src: ur_form_block_data.logo_url
      }), wp.element.createElement("h2", null, ur_form_block_data.i18n.title), wp.element.createElement(RadioControl, {
        key: "ur-gutenberg-form-selector-radio-control",
        selected: formType,
        options: [{
          label: "Registration Form",
