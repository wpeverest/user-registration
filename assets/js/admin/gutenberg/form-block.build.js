...
/***/ (function (module, exports, __webpack_require__) {
        ...
        var InspectorControls = _ref.InspectorControls;
        ...
        var SelectControl = _wp$components.SelectControl;
        var ToggleControl = _wp$components.ToggleControl;
        var PanelBody = _wp$components.PanelBody;
        var Placeholder = _wp$components.Placeholder;
        var RadioControl = _wp$components.RadioControl;
        ...
        registerBlockType("user-registration/form-selector", {
		    ...
		    var _props$attributes$for = _props$attributes.formId;
		    var formId = _props$attributes$for === undefined ? "" : _props$attributes$for;
		    var _props$attributes$for2 = _props$attributes.formType;
		    var formType = _props$attributes$for2 === undefined ? "registration_form" : _props$attributes$for2;
		    var _props$attributes$sho = _props$attributes.shortcode;
		    var shortcode = _props$attributes$sho === undefined ? "" : _props$attributes$sho;
		    var _props$attributes$red = _props$attributes.redirectUrl;
		    var redirectUrl = _props$attributes$red === undefined ? "" : _props$attributes$red;
		    var _props$attributes$log = _props$attributes.logoutUrl;
		    var logoutUrl = _props$attributes$log === undefined ? "" : _props$attributes$log;
