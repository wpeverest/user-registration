  ...
  $(function () {
    var URFormBuilder = {
      ...
      init: function () {
          ...
          $(window).on("keydown", function (e) {
            if (e.ctrlKey || e.metaKey) {
              if (
                ...
                e.preventDefault();
                window.open(user_registration_form_builder_data.ur_preview);
              }
            }
          });
        ...
        $(document.body).on("click", ".ur-toggle-bulk-options", function (e) {
          e.preventDefault();
          $this = $(this);

          var bulk_options_html = "";
          bulk_options_html += '<div class="ur-bulk-options-container">';
          bulk_options_html +=
          ...
          if ($this.parent().next(".ur-bulk-options-container").length) {
            if (
              $this
                .parent()
              ...
              $this.parent().next(".ur-bulk-options-container").show();
            } else {
              $this.parent().next(".ur-bulk-options-container").hide();
            }
          } else {
            $(bulk_options_html)
        ...
        $(document.body).on("click", ".ur-add-bulk-options", function (e) {
          e.preventDefault();
          ...
          if (options.length) {
            ...
            options_texts.forEach(function (option_text) {
              if ("" !== option_text) {
                var $add_button = options.find("li").last().find("a.add");
            ...
            bulk_options_container.find(".ur-type-textarea").val("");
          }
        });
      },
      ...
      ur_save_form: function () {
        ...
        var data = {
          ...
          data: {
            ...
            conditional_submit_settings_data: conditional_submit_settings_data,
            ...
            form_restriction_extra_settings_data:
              form_restriction_extra_settings_data,
            form_restriction_submit_data: form_restriction_submit_data
          }
        };
        ...
        if (
          typeof data.data.ur_invalid_currency_status !== "undefined" &&
          data.data.ur_invalid_currency_status[0].validation_status === false
        ) {
          URFormBuilder.show_message(
            data.data.ur_invalid_currency_status[0].validation_message
          );
          return;
        }
        ...
        if (data.data.ur_google_sheets_integration !== undefined) {
          ...
          if (
            ...
            google_sheets_connections[0].hasOwnProperty("mapped_fields")
          ) {
            var mapped_fields = google_sheets_connections[0]["mapped_fields"];
          ...
          $.each(
            ...
            function (index, field) {
              if (
                ...
                sum += parseFloat(
                  profile_completeness__custom_percentage[index + 1].value
                );
              }
            }
          );
        ...
        $.ajax({
          ...
          complete: function (response) {
            ...
            if (response.responseJSON.success === true) {
              ...
              if (!user_registration_form_builder_data.is_edit_form) {
                ...
                URFormBuilder.show_message(success_message, "success");
      ...
      get_validation_status: function () {
        ...
        $.each(
          ...
          function () {
            ...
            try {
              ...
              var length = $(".ur-input-grids .ur-general-setting-block").find(
                'input[data-field="field_name"][value="' + field_value + '"]'
              ).length;
              if (length > 1) {
                throw user_registration_form_builder_data.i18n_admin
        ...
        for (
          ...
          if (
            ...
            response.message =
              user_registration_form_builder_data.i18n_admin
                .i18n_multiple_field_key + only_one_field_index[single_field];
            break;
          }
        }
        ...
        if (paypal.is(":checked")) {
          ...
          if (stripe.is(":checked")) {
            var stripe_fields = ["payment_fields", "stripe_gateway"];
        ...
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="text"]'),
          function () {
            var $size_field = $(this)
            ...
            if ($size_field < 1) {
              ...
              response.message =
                label +
                " " +
                user_registration_form_builder_data.i18n_admin.i18n_input_size;
            }
          }
        );
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="password"]'),
          function () {
            var $size_field = $(this)
              .closest(".ur-selected-item")
              .find(".ur-advance-setting-block .ur-settings-size")
        ...
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="file"]'),
          function () {
            ...
            if (parseInt($max_upload_size) > parseInt(max_upload_size_ini)) {
              response.validation_status = false;
              response.message =
                label +
                " " +
        ...
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="number"]'),
          function () {
            var $size_field = $(this)
              .closest(".ur-selected-item")
              .find(".ur-advance-setting-block .ur-settings-size")
        ...
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="timepicker"]'),
          function () {
            var $time_interval = $(this)
              .closest(".ur-selected-item")
              .find(".ur-advance-setting-block .ur-settings-time_interval")
              .val();

            var $time_format = $(this)
              .closest(".ur-selected-item")
              .find(".ur-advance-setting-block .ur-settings-time_format")
              .val();
        ...
        $.each(
          $(".ur-input-grids").find('.ur-field[data-field-key="range"]'),
          function () {
            var $size_field = $(this)
              .closest(".ur-selected-item")
      ...
      show_message: function (message, type) {
        ...
        if ("success" === type) {
          message_string =
            ...
            user_registration_form_builder_data.i18n_admin.i18n_success +
            "! </strong>" +
            message +
          ...
          message_string =
            ...
            user_registration_form_builder_data.i18n_admin.i18n_error +
            "! </strong>" +
            message +
            '</p><span class="dashicons dashicons-no-alt ur-message-close"></span></div></div>';
        }
      ...
      get_form_data: function () {
        ...
        $.each(single_row, function () {
          ...
          $.each(grid_list_item, function () {
            var grid_item = $(this);
            var grid_wise_data = URFormBuilder.get_grid_wise_data(grid_item);
      ...
      get_field_general_setting: function ($single_item) {
        ...
        $.each(general_setting_field, function () {
          ...
          if ("options" === $(this).attr("data-field")) {
            if ("multiple_choice" === $(this).attr("data-field-name")) {
              ...
              li_elements.each(function (index, element) {
                ...
                if (
                  ...
                  general_setting_data["options"] = array_value.push({
                    label: label,
                    value: value,
              ...
              var choice_value = URFormBuilder.get_ur_data($(this)).trim();
              ...
              "subscription_plan" === $(this).attr("data-field-name")
            ) {
              var li_elements = $(this).closest("ul").find("li");
              var array_value = [];

              li_elements.each(function (index, element) {
                var label = $(element).find("input.ur-type-radio-label").val();
            ...
            } else if ("captcha" === $(this).attr("data-field-name")) {
              var li_elements = $(this).closest("ul").find("li");
              var captcha_value = [];
              ...
              li_elements.each(function (index, element) {
                ...
                var answer = $(element).find(".ur-type-captcha-answer").val();
                if (
                  captcha_value.every(function (each_value) {
                    return each_value.question !== question;
                  })
                ) {
                  general_setting_data["options"] = captcha_value.push({
                    question: question,
                    answer: answer
                  });
                }
            ...
            if ("default_value" === $(this).attr("data-field")) {
              if (is_checkbox === true) {
                if ($(this).is(":checked")) {
                  general_setting_data["default_value"] = default_values.push(
              ...
              general_setting_data[$(this).attr("data-field")] =
                URFormBuilder.get_ur_data($(this)).replace(/"/g, "'");
            } else {
              general_setting_data[$(this).attr("data-field")] =
                URFormBuilder.get_ur_data($(this));
            }
          ...
          case "input":
            ...
            switch ($this_node.attr("type")) {
              case "checkbox":
                ...
                if ($this_node.hasClass("ur-type-checkbox-value")) {
                  value = $this_node.val();
                }

                if ($this_node.hasClass("ur-type-toggle") && !value) {
                  value = "false";
                }
                break;

              default:
                if (!$this_node.hasClass("ur-type-image-choice")) {
                  value = $this_node.val();
                }
                break;
            }
      ...
      get_form_conditional_role_data: function () {
        ...
        $.each(single_row, function () {
          ...
          $.each(grid_list_item, function () {
            ...
            if (
              "user_registration_form_conditional_user_role" === $field_key[0]
            ) {
      ...
      get_form_conditional_submit_data: function () {
        ...
        $.each(single_row, function () {
          ...
          $.each(grid_list_item, function () {
            ...
            if ("user_registration_form_conditional_submit" === $field_key[0]) {
              action = $(this).val();
              grid_list_item.splice($(this), 1);
            }
          });
          ...
          $.each(or_groups, function () {
            ...
            $.each(conditional_or_group, function () {
              var inner_or_conditions = [];
              var or_list_item = $(this).find(".urcl-submit-field");
              $.each(or_list_item, function () {
                var or_conditions = {
                  field_key: $(this).attr("name"),
                  field_value: $(this).val()
        ...
        $.each(single_row, function () {
          ...
          specific_email_contents[$(this).prop("id")] = {
            ...
            content: email_body_item
              .find("#user_registration_" + $(this).prop("id") + "_content")
              .val()
          };
        });
      ...
      init_form_builder: function () {
        $.fn.ur_form_builder = function () {
          var loaded_params = {
            active_grid: user_registration_form_builder_data.active_grid,
            number_of_grid_list:
            ...
            var builder = {
              ...
              single_row: function () {
                if (!user_registration_form_builder_data.is_edit_form) {
                  ...
                  single_row
                    .find(".ur-grids")
                    .find('span[data-id="' + loaded_params.active_grid + '"]')
              ...
              manage_label_hidden_fields: function () {
                $('input[data-field="hide_label"]').each(function () {
                  if ($(this).is(":checked")) {
                    $(this)
                      .closest(".ur-selected-item")
                      .find(".ur-label")
              ...
              manage_image_choice_class: function () {
                $('input[data-field="image_choice"]').each(function () {
                  if ($(this).is(":checked")) {
                    $(this)
                      .closest(".ur-selected-item")
              ...
              manage_required_fields: function () {
                ...
                selected_inputs.find(".ur-selected-item").each(function () {
                  if (
                    $(this).find('input[data-field="required"]').is(":checked")
                  ) {
                    var label_node = $(this).find(".ur-label").find("label");
              ...
              manage_draggable_users_fields: function () {
                ...
                $.each(ul_node.find("li"), function () {
                  ...
                  if (
                    $.inArray(data_field_id, single_draggable_fields) >= 0 &&
                    ...
                    if (
                      ...
                      $this.addClass("ur-one-time-draggable-disabled");
                    } else {
                      $this.draggable("enable");
                      $this.removeClass("ur-locked-field");
                      $this.removeClass("ur-one-time-draggable-disabled");
                    }
                  }
                });
            ...
            var events = {
              ...
              register_remove_row: function () {
                ...
                $("body").on("click", ".ur-remove-row", function () {
                  if (
                    $(".ur-input-grids").find(".ur-single-row:visible").length >
                    1
                  ) {
                    var $this_row = $(this);
                    ur_confirmation(
                        ...
                        .i18n_are_you_sure_want_to_delete_row,
                      {
                        ...
                        confirm: function () {
                          ...
                          if (btn.hasClass("ur-add-new-row")) {
                            ...
                            new_btn = $this_row
                              .clone()
                              .attr("class", "dashicons-minus ur-remove-row");
                          }
                          ...
                          $(document).trigger("user_registration_row_deleted", [
                            single_row
                          ]);
              ...
              change_ur_grids: function () {
                ...
                $(document).on(
                  ...
                  function () {
                    ...
                    if (
                      $this_single_row.find(".ur-grid-lists .ur-grid-list-item")
                      ...
                      function () {
                        $(this)
                          ...
                          .each(function () {
                            ...
                            if (
                              3 ===
                                parseInt($(this).parent().attr("ur-grid-id")) &&
                        ...
                        if (
                          ...
                          iterator =
                            parseInt(grid_num) <= ++iterator ? 0 : iterator;
                        }
                      }
                    );
                    ...
                    $grids
                      .clone()
                      .insertAfter($this_single_row.find(".ur-grid-lists"));
                ...
                $("#ur-draggabled .draggable")
                  .draggable({
                    ...
                    stop: function (event, ui) {
                      if (
                        $(ui.helper).closest(".ur-grid-list-item").length === 0
                      ) {
                        return;
                      }
                      var data_field_id = $(ui.helper)
                        ...
                        .replace("user_registration_", "")
                        .trim();
                      var length_of_required = $(".ur-input-grids").find(
                        '.ur-field[data-field-key="' + data_field_id + '"]'
                      ).length;
                      ...
                      if (
                        ...
                        $.inArray(data_field_id, only_one_field_index) >= 0
                      ) {
                        show_message(
                          user_registration_form_builder_data.i18n_admin
                    ...
                    ur_confirmation(
                        ...
                        .i18n_are_you_sure_want_to_delete_field,
                      {
                        ...
                        confirm: function () {
                          ...
                          $(document.body).trigger("ur_field_removed", [
                            {
                              fieldName: fieldName,
                              fieldKey: fieldKey,
                              label: label
                ...
                $("body").on(
                  ...
                  function () {
                    ...
                    var selected_node = $(".ur-input-grids").find(
                      '.ur-field[data-field-key="' + data_field_key + '"]'
                    );
                    ...
                    clone
                      ...
                      .attr("value", label_string + new Date().getTime());
          ...
          function () {
            ...
            if (typeof field_name !== "undefined") {
              ...
              if (select_value_for_user_role === false) {
                ...
                $('[class*="urcl-field-conditional-field-select"]').append(
                  '<option value ="' +
                    field_name +
                    '" data-type="' +
                    field_key +
          ...
          $selected_countries_option_field
            ...
            .on("change", function (e) {
              $(".urcl-rules, .urcl-conditional-group").each(function () {
                var $urcl_field = $(this).find(".urcl-field").length
      ...
      init_events: function () {
          ...
          switch ($this_obj.attr("data-field")) {
            case "label":
              $this_obj.on("keyup", function () {
                URFormBuilder.trigger_general_setting_label($(this));
              });
              break;
            case "field_name":
            case "max_files":
            ...
            case "custom_class":
              $this_obj.on("change", function () {
                URFormBuilder.trigger_general_setting_field_name($(this));
              });
            case "default_value":
              $this_obj.on("change", function () {
                if ("default_value" === $this_obj.attr("data-field")) {
                  if (
                    ...
                    URFormBuilder.render_subscription_plan($(this));
                  }
                }
              });
              break;
            case "options":
              $this_obj.on("keyup", function () {
                if (
                  ...
                  $this_obj.siblings('input[data-field="default_value"]')
                    .length > 0
                ) {
                  URFormBuilder.render_select_box($(this));
                } else if (
                  $this_obj
                    .closest(".ur-general-setting-block")
                    .hasClass("ur-general-setting-multi_select2") &&
                  $this_obj.siblings('input[data-field="default_value"]')
                    .length > 0
                ) {
                ...
                URFormBuilder.trigger_general_setting_options($(this));
              });
            ...
            case "selling_price":
              ...
              $this_obj.on("change", function () {
                URFormBuilder.trigger_general_setting_selling_price($(this));
              });
              break;
            case "trail_period":
              if (!$this_obj.is(":checked")) {
              ...
              $this_obj.on("change", function () {
                URFormBuilder.trigger_general_setting_trail_period($(this));
              });
              break;
            case "placeholder":
              $this_obj.on("keyup", function () {
                URFormBuilder.trigger_general_setting_placeholder($(this));
              });
              break;
            case "required":
              $this_obj.on("change", function () {
                URFormBuilder.trigger_general_setting_required($(this));
              });
              break;
            case "hide_label":
              $this_obj.on("change", function () {
                URFormBuilder.trigger_general_setting_hide_label($(this));
              });
              break;
            case "description":
            case "html":
              $this_obj.on("keyup", function () {
                URFormBuilder.trigger_general_setting_description($(this));
              });
              break;
          }
        ...
        $.each(advance_settings, function () {
          ...
          switch ($this_node.attr("data-advance-field")) {
            ...
            case "date_format":
              $this_node.on("change", function () {
                URFormBuilder.trigger_general_setting_date_format($(this));
              });
              break;
            case "min_date":
              if (
                ...
                $(this)
                  ...
                  .flatpickr({
                    ...
                    defaultDate: new Date(
                      $(".ur-item-active").find(".ur-settings-min-date").val()
                    ),
                    onChange: function (selectedDates, dateStr, instance) {
                      $(".ur-item-active")
              ...
              if (
                ...
                $(this)
                  ...
                  .flatpickr({
                    disableMobile: true,
                    defaultDate: new Date(
                      $(".ur-item-active").find(".ur-settings-max-date").val()
                    ),
                    onChange: function (selectedDates, dateStr, instance) {
                      $(".ur-item-active")
                        .find(".ur-settings-max-date")
            ...
            case "enable_prepopulate":
              ...
              $this_node.on("click", function () {
                ...
                wrapper
                  .find(".ur-advance-setting-block")
                  .find(
                    'input[data-field="' + $(this).attr("data-field") + '"]'
                  )
          ...
          $(this).on(event, function () {
            URFormBuilder.trigger_advance_setting($this_node, node_type);
          });
      ...
      render_multi_select_box: function (this_node) {
        ...
        var options = this_node
          .closest(".ur-general-setting-options")
          .find("input.ur-general-setting-field.ur-type-checkbox-label")
          .map(function () {
            return $(this).val();
          });
        ...
        for (var i = 0; i < array_value.length; i++) {
          ...
          if (image_image.is(":checked")) {
            if (array_value[i].image && array_value[i].image.trim() !== "") {
              imageHTML =
                '<img src="' + array_value[i].image + '" width="200px">';
            } else {
              imageHTML =
                '<img src="' +
      ...
      render_multiple_choice: function (this_node) {
        ...
        li_elements.each(function (index, element) {
          var label = $(element).find("input.ur-type-checkbox-label").val();
          var value = $(element)
            .find("input.ur-type-checkbox-money-input")
            .val();
          var sell_value = $(element)
      ...
      render_subscription_plan: function (this_node) {
        ...
        li_elements.each(function (index, element) {
          var label = $(element).find("input.ur-type-radio-label").val();
          var value = $(element).find("input.ur-type-radio-money-input").val();
          var sell_value = $(element)
            .find("input.ur-radio-selling-price-input")
            .val();
          var interval_count = $(element)
        ...
        switch (node_type) {
          case "input":
            if ($this_node.attr("type") === "checkbox") {
              hidden_node.prop("checked", $this_node.is(":checked"));
            } else {
      ...
      $(document.body).on("click", ".ur-flatpickr-field", function () {
        ...
        if (!date_flatpickr) {
          ...
          if (0 < $(".ur-frontend-form").length) {
            ...
            var date_selector = $(".woocommerce-MyAccount-content #" + field_id)
              .attr("type", "text")
              .val(formated_date);
          }
      ...
      .each(function () {
        $(this).on("click", function () {
          ...
          $(this)
            ...
            .prop("checked", false);
          $(this).closest(".ur-radio-group-list--item").addClass("active");
    ...
    $(document.body).on("click", ".ur-select-smart-tag", function (event) {
      ...
      var inputElement = $(this).parent().parent().parent().find("input"),
        ...
        field_name =
          advanceFieldData !== undefined ? advanceFieldData : fieldData;
