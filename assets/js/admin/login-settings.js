...
(function ($) {
	...
	function hide_show_remember_me() {
		var value = $("#user_registration_login_options_remember_me").is(":checked"),
			form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
	...
	function hide_show_lost_password() {
		var value = $("#user_registration_login_options_lost_password").is(":checked"),
			form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
	...
	function hide_show_labels() {
		var value = $("#user_registration_login_options_hide_labels").is(":checked"),
			form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
	...
	function init_login_form_settings() {
		...
		$("#user_registration_login_options_form_template").on("change", function () {
			var value = $("#user_registration_login_options_form_template").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
			...
			if ( "default" !== value ) {
				value = ( "rounded_edge" === value ) ? "rounded ur-frontend-form--rounded-edge" : value;
		...
		$("#user_registration_general_setting_registration_url_options").on("keyup", function () {
			var value = $("#user_registration_general_setting_registration_url_options").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
		...
		$("#user_registration_general_setting_registration_label").on("keyup", function () {
			var value = $("#user_registration_general_setting_registration_label").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
		...
		$("#user_registration_label_lost_your_password").on("keyup", function () {
			var value = $("#user_registration_label_lost_your_password").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");
		...
		$("#user_registration_label_login").on("keyup", function () {
			...
			form.find(".user-registration-Button").val(value);
		...
		$("#user_registration_label_remember_me").on("keyup", function () {
			...
			form.find(".user-registration-form__label-for-checkbox span").html(value);
		...
		$("#user_registration_label_password").on("keyup", function () {
			...
			form.find(".user-registration-form-row label['for=password']").html(value + '<span class="required">*</span>');

		});

		$("#user_registration_label_username_or_email").on("keyup", function () {
			var value = $("#user_registration_label_username_or_email").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");

			form.find(".user-registration-form-row label[for='username']").html(value + '<span class="required">*</span>');

		});

		$("#user_registration_placeholder_username_or_email").on("keyup", function () {
			var value = $("#user_registration_placeholder_username_or_email").val(),
				form = $(".ur-login-form-wrapper").find(".ur-frontend-form.login");

			form.find(".user-registration-form-row #username").attr("placeholder", value);
		...
		$("#user_registration_placeholder_password").on("keyup", function () {
			...
			form.find(".user-registration-form-row #password").attr("placeholder", value);
