function ur_init_tooltips(e, t) {
	if (undefined !== e && null !== e && "" !== e) {
		...
		t &&
			...
			"string" == typeof e ? jQuery(e).tipTip(i) : e.tipTip(i);
	}
}
function ur_alert(e, t) {
	void 0 === t && (t = {}),
		Swal.fire({
			type: "error",
			title: t.title,
...
function ur_confirmation(e, t) {
	void 0 === t && (t = {});
	var i =
		'<i class="dashicons dashicons-trash"></i><span class="user-registration-swal2-modal__title">' +
		t.title;
	Swal.fire({
		customClass:
		...
		text: e,
		showCancelButton:
			"undefined" == typeof t.showCancelButton || t.showCancelButton,
		confirmButtonText:
			"undefined" != typeof t.confirmButtonText
				? t.confirmButtonText
				: user_registration_admin_data.i18n_admin.i18n_choice_delete,
		confirmButtonColor: "#ff4149",
		cancelButtonText:
			"undefined" != typeof t.cancelButtonText
				? t.cancelButtonText
				: user_registration_admin_data.i18n_admin.i18n_choice_cancel,
	}).then(function (e) {
		e.value ? t.confirm() : t.reject();
	});
}
jQuery(function (e) {
	e(document.body).on(
		...
		e(document.body).on("input", "#ur-search-fields", function () {
			var t = e(this).val().toLowerCase();
			e(".ur-registered-item").each(function () {
				e(this).text().toLowerCase().search(t) > -1
					? (e(this).addClass("ur-searched-item"), e(this).show())
					: (e(this).removeClass("ur-searched-item"), e(this).hide());
			}),
				e(".ur-registered-list").each(function () {
					var t = e(this).find(".ur-registered-item.ur-searched-item")
							.length,
						i = e(this).prev("hr"),
						r = e(this).prev("hr").prev(".ur-toggle-heading");
					0 === t ? (i.hide(), r.hide()) : (i.show(), r.show());
				}),
				e(".ur-registered-item.ur-searched-item").length
					? e(".ur-fields-not-found").hide()
					: e(".ur-fields-not-found").show();
		}),
		e(document).on("mousedown", ".ur-upgradable-field", function (t) {
			t.preventDefault();
			var i = e(this).text(),
				r =
					'<i class="dashicons dashicons-lock"></i><span class="user-registration-swal2-modal__title">' +
					i +
		...
		e(window).on("resize orientationchange", function () {
			...
			clearTimeout(t),
				(t = setTimeout(function () {
					e(document.body).trigger("adjust_builder_width");
				}, 250));
		}),
		e(document.body).on("click", "#collapse-button", function () {
			e(document.body).trigger("ur_adjust_builder_width");
		}),
		e(document.body)
			.on("ur_adjust_builder_width", function () {
				var t = e("#adminmenuwrap").width(),
					i = e(
		...
		e(document.body).on(
			...
			function () {
				...
				t.hasClass("is-editing") || t.focus(),
					t.toggleClass("is-editing"),
					t.attr(
						"data-editing",
						"true" == t.attr("data-editing") ? "false" : "true"
					);
			}
		),
		e(document.body)
			.not(e(".user-registration-editable-title"))
			.click(function (t) {
				var i = e(".user-registration-editable-title__input");
				"ur-form-name" !== t.target.id &&
					"ur-form-name-edit-button" !== t.target.id &&
					!i.attr("hidden") &&
					i.hasClass("is-editing") &&
					(t.stopPropagation(),
					"true" !== i.data("data-editing") &&
						i.val() &&
						"" !== i.val().trim() &&
						i
			...
			function () {
				if ("undefined" != typeof PerfectScrollbar) {
					...
					"undefined" == typeof window.ur_tab_scrollbar
						...
						: "undefined" != typeof window.ur_tab_scrollbar &&
						  (window.ur_tab_scrollbar.update(), t.scrollTop(0));
				}
			}
		),
		e(document).ready(function () {
			e(document).trigger("init_perfect_scrollbar");
			var t = e(".ur-selected-inputs"),
				i = e(".ur-registered-inputs nav").find(
					"#ur-tab-field-settings"
				);
			i.find("form").appendTo(t),
				t
					.find("form #ur-field-all-settings > div")
					.each(function (t, r) {
						var n = e(r).find("h3").text(),
							a = e(r).attr("id");
						i.append(
							'<div id="' +
								a +
				...
				i.find("#general-settings").addClass("active"),
				t.find("#ur-field-all-settings div#general-settings").show(),
				i.find(".form-settings-tab").on("click", function () {
					(this_id = e(this).attr("id")),
						e(this).siblings().removeClass("active"),
						e(this).addClass("active"),
						t.find("form #ur-field-all-settings > div").hide(),
						t
							.find(
								"form #ur-field-all-settings > div#" + this_id
							)
							.show(),
						e(document).trigger("update_perfect_scrollbar"),
						e(".ur-builder-wrapper").scrollTop(0);
				});
		}),
		e(document).on(
			"click",
			...
			function (t, i) {
				e(document).trigger("update_perfect_scrollbar"),
					"triggered_click" != i &&
						(e(".ur-builder-wrapper").scrollTop(0),
						e(".ur-builder-wrapper-content").scrollTop(0));
			}
		),
		e(document).on(
			"click",
			...
			function () {
				e(".ur-builder-wrapper-content").hide(),
					e(".ur-builder-wrapper-footer").hide(),
					e(".ur-selected-inputs")
	...
	"yes" === r || !0 === r ? t.show() : t.hide(),
		...
		e(document.body)
			.on("init_tooltips", function () {
				ur_init_tooltips(
					".tips, .help_tip, .user-registration-help-tip"
				),
					ur_init_tooltips(
					...
					e(".parent-tips").each(function () {
						e(this)
							.closest("a, th")
							.attr("data-tip", e(this).data("tip"))
							.tipTip(tiptip_args)
							.css("cursor", "help");
					});
			})
			.trigger("init_tooltips"),
		e("body").on("keypress", "#ur-form-name", function (t) {
			13 === t.which && e("#save_form_footer").eq(0).trigger("click");
		}),
		e("#ur-full-screen-mode").on("click", function (t) {
			t.preventDefault();
			var i = e(this);
			i.hasClass("closed")
				? (i.removeClass("closed"),
				  i.addClass("opened"),
				  e("body").addClass("ur-full-screen-mode"))
				: (i.removeClass("opened"),
				  i.addClass("closed"),
				  e("body").removeClass("ur-full-screen-mode"));
		}),
		e(document).on("keyup", function (t) {
			"Escape" === t.key &&
				e("#ur-full-screen-mode.opened").trigger("click");
		}),
		e("input.input-color").wpColorPicker();
}),
	(function (e, t) {
		function i() {
			var i = (function () {
				var i = e.makeArray(t.form_one_time_draggable_fields),
					r = e.makeArray(t.form_required_fields),
					n = { validation_status: !0, message: "" };
				if (0 === e(".ur-selected-item").length)
					return (
						(n.validation_status = !1),
						(n.message =
							t.i18n_admin.i18n_at_least_one_field_need_to_select),
						n
					);
				if ("" === e("#ur-form-name").val())
					return (
						(n.validation_status = !1),
						(n.message = t.i18n_admin.i18n_empty_form_name),
						n
					);
				if (
					e(".ur_save_form_action_button").find(".ur-spinner")
						.length > 0
				)
					return (
						(n.validation_status = !1),
						(n.message =
							t.i18n_admin.i18n_previous_save_action_ongoing),
						n
					);
				e.each(
					e(
					...
					function () {
						var i = e(this).val();
						if (!i || (Array.isArray(i) && 0 === i.length))
							return (
								(n.validation_status = !1),
								(n.message =
									t.i18n_admin.i18n_select_countries),
								n
							);
					}
				),
								...
								if (
									...
									throw (
										((r = r
											...
											.find('input[data-field="label"]')),
										t.i18n_admin.i18n_empty_field_label)
									);
								var d = s.match(
									/[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/gm
								);
								if (null === d || 1 !== d.length || d[0] !== s)
									throw t.i18n_admin.i18n_invald_field_name;
							} catch (o) {
								(n.validation_status = !1),
									(n.message =
										o.message === undefined
				...
				for (var a = 0; a < i.length; a++)
					if (
						e(".ur-input-grids").find(
							'.ur-field[data-field-key="' + i[a] + '"]'
						).length > 1
					) {
						(n.validation_status = !1),
							(n.message =
								t.i18n_admin.i18n_multiple_field_key + i[a]);
						break;
					}
				for (var s = 0; s < r.length; s++)
					if (
						0 ===
						e(".ur-input-grids").find(
							'.ur-field[data-field-key="' + r[s] + '"]'
						).length
					) {
						if (((n.validation_status = !1), 0 === s))
							var l = t.i18n_admin.i18n_user_email;
						else if (1 === s)
							var l = t.i18n_admin.i18n_user_password;
						n.message =
							l + " " + t.i18n_admin.i18n_field_is_required;
						break;
					}
				return n;
			})();
			if (!1 !== i.validation_status) {
				var n = (function () {
						var t = [],
							i = e(".ur-input-grids .ur-single-row");
						return (
							e.each(i, function () {
								var i = e(this).find(".ur-grid-list-item"),
									r = [];
								e.each(i, function () {
									var t = (function (t) {
										var i = t.find(".ur-selected-item"),
											r = [];
										return (
											e.each(i, function () {
												var t = e(this),
					...
					s = (function () {
						...
						return (
							e.each(i, function () {
								t.push(e(this).attr("data-row-id"));
							}),
							t
						);
					})(),
				...
				var d = e(
					...
					o = (function () {
						var t = [],
							i = e(".urcl-role-logic-wrap");
						return (
							e.each(i, function () {
								var i = e(this).find(".urcl-user-role-field"),
									r = [],
									n = [],
									a = "";
								e.each(i, function () {
								...
								var s = e(this).find(".urcl-conditional-group");
								e.each(s, function () {
									var t = [],
										i = e(this).find(
									...
									e.each(i, function () {
										var i = {
											field_key: e(this).attr("name"),
											field_value: e(this).val(),
										};
										t.push(i);
									}),
										r.push(t);
								});
								var l = e(this).find(".urcl-or-groups");
								e.each(l, function () {
									var t = e(this).find(
					...
					c = e("#ur-multi-part-page-settings").serializeArray(),
					f = {
						action: "user_registration_form_save_action",
						security: t.ur_form_save,
						data: {
							form_data: JSON.stringify(n),
							form_row_ids: JSON.stringify(s),
							form_name: e("#ur-form-name").val(),
							form_id: l,
							form_setting_data: d,
							conditional_roles_settings_data: o,
							email_content_override_settings_data: u,
							multipart_page_setting: c,
						},
					};
				e.ajax({
					url: t.ajax_url,
					...
					type: "POST",
					beforeSend: function () {
						e(".ur_save_form_action_button").append(
					...
					complete: function (i) {
						if (
							(e(".ur_save_form_action_button")
								.find(".ur-spinner")
								.remove(),
							!0 === i.responseJSON.success)
						) {
							var n = t.i18n_admin.i18n_form_successfully_saved;
							if ("1" !== t.is_edit_form) {
								(message_body =
		...
		function r(i, r) {
			var a = e(".ur-form-container").find(
		...
		function n(e) {
			e.removeClass("entered").addClass("exiting"),
				setTimeout(function () {
					e.remove();
				}, 120);
		}
		...
		function s() {
			var t = e(".ur-general-setting-field");
			e.each(t, function () {
				var t = e(this);
				switch (t.attr("data-field")) {
					case "label":
						t.on("keyup", function () {
							!(function (t) {
								var i = e(".ur-selected-item.ur-item-active");
								i.find(".ur-label").find("label").text(t.val()),
									i
					...
					case "default_value":
						t.on("change", function () {
							"default_value" === t.attr("data-field") &&
								(t
									.closest(".ur-general-setting-block")
					...
					case "required":
						t.on("change", function () {
							!(function (t) {
								...
								i.find(".ur-general-setting-block")
									.find(
										'select[data-field="' +
											t.attr("data-field") +
											'"]'
					...
					case "hide_label":
						t.on("change", function () {
							!(function (t) {
								e(".ur-selected-item.ur-item-active")
									.find(".ur-general-setting-block")
									.find(
										'select[data-field="' +
											t.attr("data-field") +
			...
			var i = e("#ur-setting-form .ur_advance_setting");
			e(".ur-settings-enable-min-max").on("change", function () {
				"true" === e(this).val()
					? (e(
					  ...
					  e("#ur-setting-form .ur-settings-min-date")
					  ...
					  e("#ur-setting-form .ur-settings-max-date")
							.addClass("flatpickr-field")
							.flatpickr({
								disableMobile: !0,
								static: !0,
				...
				e.each(i, function () {
					var t = e(this);
					switch (t.attr("data-advance-field")) {
						case "date_format":
							t.on("change", function () {
								!(function (t) {
									e(".ur-selected-item.ur-item-active")
					...
					var i = t.get(0).tagName.toLowerCase();
					"country_advance_setting_default_value" ===
						t.attr("data-id") &&
						e(".ur-builder-wrapper #ur-input-type-country")
							.find('option[value="' + t.val() + '"]')
							.attr("selected", "selected");
					var r = "change";
					switch (i) {
					...
					"valid_file_type" === t.attr("data-advance-field") &&
						t.select2(),
		...
		function l(t, i) {
			var r = e(".ur-selected-item.ur-item-active"),
				n = t.attr("data-id"),
				a = r
			...
			switch (i) {
				...
				case "select":
					if (
						...
						a.find('option[value="' + t.val() + '"]').attr(
							"selected",
							"selected"
						);
					break;
		...
		function d(t) {
			var i = [],
				r = t.closest("ul").find("li"),
				n = t.closest("li").index();
			r.each(function (t, r) {
				var n = e(r).find("input.ur-type-checkbox-label").val();
				(n = e.trim(n)),
					(s = e(r)
					...
					i.every(function (e) {
						return e.value !== n;
					}) && i.push({ value: n, checkbox: s });
			});
			var a = e(".ur-selected-item.ur-item-active"),
				s = a.find(".ur-field");
			s.html("");
		...
		function o(t) {
			var i = t.closest("ul").find("li"),
				r = undefined,
				n = [];
			i.each(function (t, i) {
				var a = e(i).find("input.ur-type-radio-label").val();
				(a = e.trim(a)),
					!0 ===
						(s = e(i)
			...
			a.find(
				...
				var n = e(i).find('[data-field="default_value"]');
				t === r ? n.prop("checked", !0) : n.removeAttr("checked");
			});
		}
		function u(t) {
			var i = e.trim(t.val()),
				r = e(".ur-selected-item.ur-item-active"),
				n = t.closest("li").index(),
				a = r.find(".ur-field").find("select");
			a.html(""),
				...
				r
					...
					.each(function (t, i) {
						var r = e(i).find('[data-field="default_value"]');
						t === n
							? r.prop("checked", !0)
		...
		function c() {
			var i = t.form_one_time_draggable_fields,
				r = e("#ur-tab-registered-fields").find(
		...
		function f(t) {
			e(".ur-grid-lists .ur-selected-item .ur-general-setting").each(
				function () {
					var i = e(this)
							.closest(".ur-selected-item")
					...
					if (
						...
						"html" != r &&
						"wysiwyg" != r &&
						"billing_address_title" != r &&
						"shipping_address_title" != r
					) {
						var n = e(this).find("[data-field='field_name']").val();
						if (void 0 !== n) {
							!1 ===
								e(
		...
		e(function () {
			({
				...
				add_item: function (t) {
					return (
						t.preventDefault(),
						e(this).URBackboneModal({ template: "test-demo" }),
						!1
					);
				},
				backbone: {
				...
				(e.fn.ur_form_builder = function () {
					var i = {
						active_grid: t.active_grid,
						number_of_grid_list: t.number_of_grid,
						min_grid_height: 70,
					};
							...
							a = {
								...
								single_row: function () {
									if ("1" !== t.is_edit_form) {
										...
										r.append(e("<div class='ur-grids'/>"));
										var l = this.get_grid_button();
										r.find(".ur-grids").append(l),
											r
												.find(".ur-grids")
												.find(
													'span[data-id="' +
										...
										r.append(
											...
											e(".ur-single-row")
												...
												.find(".ur-grid-list-item")
												.eq(0)
												.append(t.required_form_html);
									}
									if (0 == n.find(".ur-add-new-row").length) {
										n.append(
										...
										var o = n
											...
											.prev()
											.attr("data-row-id");
										n.find(".ur-add-new-row").attr(
											"data-total-rows",
											o
										);
									}
									s.render_draggable_sortable(),
										a.manage_empty_grid(),
										c();
								},
								get_grid_lists: function (t) {
									for (
										var r = e(
										...
										var a = e(
											...
											s = Math.floor(100 / t) - t;
										a.css({
											width: s + "%",
											"min-height":
												i.min_grid_height + "px",
										}),
											r.append(a);
									}
									return (
								...
								populate_dropped_node: function (i, r) {
									var n = {
											action:
												"user_registration_user_input_dropped",
											security: t.user_input_dropped,
											form_field_id: r,
										},
										s =
											'<div class="ur-selected-item ajax_added"><div class="ur-action-buttons"><span title="Clone" class="dashicons dashicons-admin-page ur-clone"></span><span title="Trash" class="dashicons dashicons-trash ur-trash"></span></div>(content)</div>';
									i
							...
							s = {
												...
												stop: function (i, n) {
													if (
														...
														var s = e.trim(
															...
															d = e.makeArray(
																t.form_one_time_draggable_fields
															);
														if (
															l > 0 &&
															e.inArray(s, d) >= 0
								...
								check_grid: function () {
									e(".ur-tabs").tabs({ disabled: [1] }),
										...
										e(".ur-selected-item").removeClass(
											"ur-item-active"
										);
								},
							};
				...
				e(".ur-input-grids").ur_form_builder(),
				e(".ur-tabs .ur-tab-lists")
					.find("a.nav-tab")
					.click(function () {
						e(".ur-tabs .ur-tab-lists")
							.find("a.nav-tab")
			...
			e.fn.select2.amd.require(
					...
					(n = d.Decorate(t, i)),
						...
						(u.prototype.render = function (t) {
							...
							return (
								...
								r.find(".select2-dropdown").prepend(n),
								r
							);
						}),
						(a = d.Decorate(a, u)),
						(c.prototype.render = function (t) {
							...
							return (
								n.on("click", function () {
									var t = [];
									i.$element.find("option").each(function () {
										t.push(e(this).val());
									}),
										i.$element.val(t),
										i.$element.trigger("change"),
				...
				e(document).on("click", ".ur-selected-item", function () {
					e(".ur-registered-inputs")
						.find("ul li.ur-no-pointer")
						.removeClass("ur-no-pointer"),
						e(".ur-selected-item").removeClass("ur-item-active"),
						e(this).addClass("ur-item-active"),
						(function (t) {
							var i = t.find(".ur-advance-setting-block").clone(),
								r = t.find(".ur-general-setting-block").clone(),
								n = e("<form id='ur-setting-form'/>");
							e("#ur-tab-field-options").html(""),
								n.append(r),
								n.append(i),
								e("#ur-tab-field-options").append(n),
								e("#ur-tab-field-options")
									.find(".ur-advance-setting-block")
									.show(),
								e("#ur-tab-field-options")
									.find(".ur-general-setting-block")
									.show(),
								1 === e(".ur-item-active").length &&
									(e(".ur-tabs").tabs("enable", 1),
									e(".ur-tabs")
										.find("a")
										.eq(1)
										.trigger("click", ["triggered_click"])),
								e(".ur-options-list").sortable({
									containment: ".ur-general-setting-options",
								});
						})(e(this)),
						s(),
						e(document).trigger("update_perfect_scrollbar");
					var t = e(this).find(".ur-field").data("field-key");
					if (
						"country" === t ||
						"billing_country" === t ||
						"shipping_country" === t
						...
						i.on("change", function (t) {
							...
							.select2({
								...
								templateSelection: function (e) {
									...
									var t = 0;
									return (
										i.val() && (t = i.val().length),
										"Selected " + t + " country(s)"
									);
								},
							})
							.on("change", function (t) {
								e(".urcl-rules, .urcl-conditional-group").each(
									function () {
										var t = e(this).find(".urcl-field")
												.length
												? e(this).find(".urcl-field")
												: e(this).find(
														".urcl-form-group"
												  ),
											i = t
							...
							.on("select2:close", function (t) {
								setTimeout(function () {
									e(":focus").blur();
								}, 1);
							});
					}
					e(document.body).trigger("ur_rendered_field_options"),
						e(document.body).trigger("init_tooltips");
				}),
				e(".ur_import_form_action_button").on("click", function () {
					var i = e("#jsonfile").prop("files")[0],
						r = new FormData();
					r.append("jsonfile", i),
						r.append(
							"action",
							"user_registration_import_form_action"
						),
						r.append("security", t.ur_import_form_save),
						e.ajax({
							url: t.ajax_url,
							dataType: "json",
							cache: !1,
									...
									(r =
										!0 === i.responseJSON.success
											...
											: '<div id="message" class="error inline ur-import_notice"><p><strong>' +
											  i.responseJSON.data.message +
											  "</strong></p></div>"),
									e(".ur-export-users-page").prepend(r),
									e("#jsonfile").val(""),
									e(
										".user-registration-custom-selected-file"
									).html(t.no_file_selected);
							},
						});
				}),
				e(".ur_save_form_action_button").on("click", function () {
					i();
				}),
				e(document.body).on(
					"click",
				...
				e(document.body).on(
					...
					function (t) {
						t.stopPropagation(),
							e(".ur-quick-links-content").slideToggle();
					}
				),
				e(document.body).on("click", function (t) {
					e(".ur-quick-links-content").is(":hidden") ||
						e(".ur-quick-links-content").slideToggle();
				}),
			...
			e(document).on(
				...
				function () {
					($message = e(this).closest(".ur-message")), n($message);
				}
			),
			e(document).ready(function () {
				var t = {};
				e(document.body).on("click", "#load_flatpickr", function () {
					var i = e(this).data("id"),
						r = t[i];
					if (!r) {
						var n = e(this).siblings("#formated_date").val()
								? e(this).siblings("#formated_date").val()
								: e(this)
							...
							a = e(
								...
								.attr("type", "text")
								.val(n);
						e(this).attr("data-date-format", a.data("date-format")),
							e(this).attr("data-mode", a.data("mode")),
							e(this).attr("data-min-date", a.data("min-date")),
							e(this).attr("data-max-date", a.data("max-date")),
							e(this).attr("data-default-date", n),
							(r = e(this).flatpickr({
								disableMobile: !0,
								...
								onOpen: function (e, t, i) {
									i.set("minDate", a.data("min-date")),
										i.set("maxDate", a.data("max-date"));
								},
							})),
							(t[i] = r);
					}
			...
			e(document).on("click", ".ur-toggle-heading", function () {
				e(this).hasClass("closed")
					? e(this).removeClass("closed")
					: e(this).addClass("closed");
				var t = e(this).find(" ~ .ur-registered-list")[0];
				e(t).slideToggle(),
					e(this).siblings(".ur-toggle-content").slideToggle();
			}),
			e(document).on("click", ".ur-options-list .add", function (t) {
				t.preventDefault();
				var i = e(this),
					r = e(".ur-selected-item.ur-item-active"),
					n = i.parent("li").index(),
					a = i.parent("li").clone(!0, !0);
				a.find('input[data-field="options"]').val(""),
					a
			...
			e(document).on("click", ".ur-options-list .remove", function (t) {
				t.preventDefault();
				var i = e(this),
					r = e(this).closest("ul");
				($any_siblings = r.find("li")),
					($wrapper = e(".ur-selected-item.ur-item-active")),
					(this_index = i.parent("li").index()),
					r.find("li").length > 1 &&
						(i.parent("li").remove(),
						$wrapper
							.find(
			...
			e(document).on("sortstop", ".ur-options-list", function (t, i) {
				var r = e(this);
				!(function (t) {
					var i = t.clone(!0, !0),
						r = e(".ur-selected-item.ur-item-active").find(
							".ur-general-setting-options .ur-options-list"
						);
					r.html(""), r.replaceWith(i);
				})(r),
					r
						.closest(".ur-general-setting-block")
						.hasClass("ur-general-setting-radio")
