			...
			<div class="ur-membership-selection-container ur-d-flex ur-p-1" style="gap:20px;">
				...
				<div class="ur-input-type-select ur-admin-template" style="width: 100%">
					<div class="ur-field ur-d-flex" data-field-key="radio">
						...
						<!-- Subscription Type -->
						<label class="ur-membership-types <?php echo ! UR_PRO_ACTIVE ? 'upgradable-type' : ''; ?>" for="ur-membership-subscription-type">
							<div class="ur-membership-type-title ur-d-flex ur-align-items-center">
								<input data-key-name="Type" id="ur-membership-subscription-type" style="margin: 0"
									type="radio" value="subscription" name="ur_membership_type" class="ur_membership_paid_type"
						...
						<div class="ur-input-type-select ur-admin-template" style="width: 100%">
							<div class="ur-field ur-d-flex ur-align-items-center" style="gap: 10px">
								<input data-key-name="Cancel Subscription" type="radio"
										...
										name="ur_membership_cancel_on" value="immediately"
								...
								<label for="ur-membership-cancel-sub-immediately"><?php echo __( 'Cancel immediately.', 'user-registration' ); ?></label>
							</div>
						</div>
					</div>
				</div>
