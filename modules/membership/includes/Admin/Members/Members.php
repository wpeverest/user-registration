	...
	class Members {
		...
		public function enqueue_scripts() {
			...
			wp_register_script(
				...
				UR_MEMBERSHIP_JS_ASSETS_URL . '/admin/user-registration-members-admin' . $suffix . '.js',
				array(
					'jquery',
					'ur-enhanced-select',
			...
			<div id="user-registration-list-table-page">
				<div class="user-registration-list-table-heading" id="ur-users-page-topnav">
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . $this->page . '&action=add' ) ); ?>"
						...
						class="page-title-action <?php echo ( ! $license_validity ? 'ur-required-license-activation' : ( $license_validity['renew'] ? 'ur-required-renewable' : '' ) ); ?>"><?php esc_html_e( 'Add New', 'user-registration' ); ?></a>
				</div>
