...
<html lang="en">
<head>
	<title><?php echo esc_html( 'Payment Successful Email', 'user-registration' ); ?></title>
</head>
...
<div style="padding: 100px 0;">
	<div
		...
		<table style="font-family: arial, sans-serif; border-collapse: collapse; width: 100%;">
			<tr>
				<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Field', 'user-registration' ); ?></th>
				<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Details', 'user-registration' ); ?></th>
			</tr>
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Membership Name', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo ucwords( $invoice_details['membership_name'] ); ?></td>
			</tr>
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Trial Status', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo ucfirst( $invoice_details['trial_status'] ); ?></td>
			</tr>
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Trial Start Date', 'user-registration' ); ?></td>
			...
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Trial End Date', 'user-registration' ); ?></td>
			...
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Next Billing Date', 'user-registration' ); ?></td>
			...
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Payment Date', 'user-registration' ); ?></td>
			...
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Billing Cycle', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo $invoice_details['billing_cycle']; ?></td>
			</tr>
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Amount', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo $invoice_details['amount']; ?></td>
			</tr>
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Trial Amount', 'user-registration' ); ?></td>
			...
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Coupon', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo $invoice_details['coupon']; ?></td>
			</tr>
			<tr style="background-color: #dddddd;">
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Coupon Discount', 'user-registration' ); ?></td>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo $invoice_details['coupon_discount']; ?></td>
			</tr>
			<?php endif; ?>
			<tr>
				<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?php echo esc_html( 'Total', 'user-registration' ); ?></td>
