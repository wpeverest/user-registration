...
const Main = ({ filter }) => {
    ...
    const categories = useMemo(() => {
        ...
        return [
            { name: __("All Forms", "user-registration"), count: templates.length },
    ...
    const filteredTemplates = useMemo(() => {
        return templates.filter(template =>
            (selectedCategory === __("All Forms", "user-registration") || template.categories.includes(selectedCategory)) &&
