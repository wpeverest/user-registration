			...
			<div class="ur-form-row">
				...
				?>
					...
					<div>
						...
						<?php } else { ?>
							<button type="submit" class="user-registration-Button button <?php echo  ($is_login_settings || ( isset( $_GET['ur_login_preview'] ) && $_GET['ur_login_preview'] ) )  ? 'ur-disabled-btn' : ''; ?> " name="login" value="<?php echo esc_html( $labels['login'] ); ?>" <?php echo  ($is_login_settings || ( isset( $_GET['ur_login_preview'] ) && $_GET['ur_login_preview'] ) )  ? 'disabled' : ''; ?> ><?php echo esc_html( $labels['login'] ); ?></button>
						<?php } ?>
					</div>
