...
$logout_confirmation = ur_option_checked( 'user_registration_disable_logout_confirmation', apply_filters( 'user_registration_disable_logout_confirmation_status', true ) );
?>
