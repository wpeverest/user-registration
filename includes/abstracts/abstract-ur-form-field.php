...
abstract class UR_Form_Field {
	...
	public function get_field_general_settings() {
		...
		foreach ( $general_settings as $setting_key => $setting_value ) {
			...
			$general_setting_wrapper  = '<div class="ur-general-setting ur-setting-' . $setting_value['type'] . ' ur-general-setting-' . str_replace( ' ', '-', strtolower(isset($setting_value['setting_id'] ) ? $setting_value['setting_id'] : $setting_value['label'] ) ) . '">';
