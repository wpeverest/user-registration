				...
				case 'checkbox':
					...
					if ( 'multiple_choice' === $strip_prefix ) {
						...
						foreach ( $options as $key => $option ) {
							...
							$general_setting_wrapper .= '<div class="ur-choice-buttons"><a class="add" href="#"><i class="dashicons dashicons-plus"></i></a>';
							$general_setting_wrapper .= '<a class="remove" href="#"><i class="dashicons dashicons-minus"></i></a><br/></div>';
							$general_setting_wrapper .= '</li>';
						}
					} else {
