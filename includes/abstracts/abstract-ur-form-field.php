			...
			switch ( $setting_value['type'] ) {
				...
				case 'radio':
					...
					foreach ( $options as  $option ) {
						...
						$general_setting_wrapper .= '<input value="' . esc_attr( $default_value ) . '" data-field="default_value" class="ur-general-setting-field ur-type-' . $setting_value['type'] . '-value" type="radio" name="' . $unique . '_value" ';
