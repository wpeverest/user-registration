...
abstract class UR_Form_Field {
	...
	public function frontend_includes( $form_id, $field_type, $field_key, $data = array() ) {
		...
		if ( isset( $data['advance_setting']->date_localization ) ) {
			wp_register_script( 'flatpickr-localization', 'https://npmcdn.com/flatpickr/dist/l10n/' . $data['advance_setting']->date_localization . '.js', array(), '4.6.13' );
			wp_enqueue_script( 'flatpickr-localization' );
