...
class UR_Elementor_Widget_Edit_Profile extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'form', 'forms', 'user-registration', 'login form', 'user-registration-edit-profile', 'userregistrations' );
	}
	/**
	 * Register controls.
	 *
	...
	private function get_shortcode() {
		...
		$shortcode = sprintf( '[user_registration_edit_profile]' );
		return $shortcode;
	}
	/**
	...
	public function get_forms() {
		...
		if ( empty( $user_registration_forms ) ) {
			$user_registration_forms['ur_edit_profile'] = esc_html__( 'Login Form', 'user-registration' );
