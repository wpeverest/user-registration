...
class UR_Shortcode_My_Account {
	...
	public static function edit_account() {
		$user_id                   = get_current_user_id();
		$form_id                   = get_user_meta( $user_id, 'ur_form_id', true );
		$enable_strong_password    = get_option( 'user_registration_my_account_enable_strong_password', 'yes' );
		$minimum_password_strength = get_option( 'user_registration_my_account_minimum_password_strength', 3 );
