...
<div id="message" class="updated user-registration-message ur-connect">
	<p><strong><?php esc_html_e( 'User Registration & Membership Data Update', 'user-registration' ); ?></strong> &#8211; <?php esc_html_e( 'We need to update your site\'s database to the latest version.', 'user-registration' ); ?></p>
