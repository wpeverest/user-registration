...
if ( ! class_exists( 'UR_Settings_Payment_Retry_Email', false ) ) :

	/**
	 * UR_Settings_Payment_Retry_Email Class.
	 */
	class UR_Settings_Payment_Retry_Email {
		/**
		...
		public function __construct() {
			$this->id          = 'payment_retry_email';
			$this->title       = esc_html__( 'Payment Retry', 'user-registration' );
			$this->description = esc_html__( 'Email sent for failed subscription payment.', 'user-registration' );
			$this->receiver    = 'User';
		}
		...
		public function get_settings() {
			...
			$settings = apply_filters(
				'user_registration_payment_retry_email',
				array(
					'title'    => __( 'Emails', 'user-registration' ),
					'sections' => array(
						'payment_retry_email' => array(
							'title'        => esc_html__( 'Payment Retry Email', 'user-registration' ),
							'type'         => 'card',
							'desc'         => '',
							...
							array(
								...
								'type'     => 'tinymce',
								'default'  => $this->ur_get_payment_retry_email(),
								'css'      => '',
								'desc_tip' => true,
		 ...
		 */
		public static function ur_get_payment_retry_email() {
...
return new UR_Settings_Payment_Retry_Email();
