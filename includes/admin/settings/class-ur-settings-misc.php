					...
					'sections' => array(
						'advanced_settings' => array(
							...
							'settings' => array(
								...
								array(
									'title'    => __( 'Auto Delete Unverified Accounts ', 'user-registration' ),
									'desc_tip' => __( 'Automatically delete registered users who have not activated their accounts within a specified period.', 'user-registration' ),
									'id'       => 'user_registration_allow_delete_inactive_users',
									'type'     => 'toggle',
									'css'      => 'min-width: 350px;',
									'default'  => 'no',
								),
								array(
									'title'    => __( 'Account Deletion Period ', 'user-registration' ),
									'desc'     => __( 'Enter a number for how long unactivated accounts are kept before deletion', 'user-registration' ),
									'id'       => 'user_registration_delete_inactive_users_unit',
									'type'     => 'text',
									'default'  => '',
									'desc_tip' => true,
									'css'      => 'min-width: 350px;',
								...
								array(
									'title'    => __( 'Deletion Period Unit', 'user-registration' ),
									'desc'     => __( 'Select the unit of time for the unverified user deletion period.', 'user-registration' ),
									'id'       => 'user_registration_delete_inactive_users_unit_type',
									'type'     => 'select',
									'default'  => 'days',
									'options'  => array(
										'days'   => __( 'Days', 'user-registration' ),
										'weeks'  => __( 'Weeks', 'user-registration' ),
										'months' => __( 'Months', 'user-registration' ),
										'years'  => __( 'Years', 'user-registration' ),
									),
									'desc_tip' => true,
									'css'      => 'min-width: 350px;',
								),
