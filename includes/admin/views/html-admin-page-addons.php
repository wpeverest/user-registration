...
<div class="wrap ur_addons_wrap">
	...
	<a href="<?php echo esc_url( $refresh_url ); ?>"
		class="page-title-action"><?php esc_html_e( 'Refresh Extensions', 'user-registration' ); ?></a>
	<?php endif; ?>
	...
	<ul class="subsubsub">
		...
		<li><a class="<?php echo $current_section === $section_id ? 'current' : ''; ?>"
				href="<?php echo esc_url( admin_url( 'admin.php?page=user-registration-addons&section=' . esc_attr( $section_id ) ) ); ?>"><?php echo esc_html( $section->title ); ?></a>
		</li>
		<?php endforeach; ?>
	</ul>
	<br class="clear" />
			...
			<div class="plugin-card plugin-card-<?php echo esc_attr( $addon->slug ); ?>">
				<div class="plugin-card-left">
					<a href="<?php echo esc_url( $addon->link ); ?>">
						<img src="<?php echo esc_url( UR()->plugin_url() . '/assets/' . $addon->image ); ?>"
				...
				<div class="plugin-card-right">
					...
					<div class="plugin-card-buttons">
						...
						<div class="action-buttons upgrade-plan">
							<a class="button upgrade-now"
								href="https://wpuserregistration.com/pricing/?utm_source=addons-page&utm_medium=upgrade-button&utm_campaign=ur-upgrade-to-pro"
								target="_blank"><?php esc_html_e( 'Upgrade Plan', 'user-registration' ); ?></a>
						</div>
						<?php } ?>
					</div>
				</div>
