  ...
  <path fill-rule="evenodd"
	...
	<table>
		...
		$plugin_pages = array(
			...
			'user_registration_member_registration_page_id' => __( 'Membership Registration Page', 'user-registration' ),
			'user_registration_thank_you_page_id' => __( 'Thank You Page', 'user-registration' ),
		);
