				...
				<div id="nav-menu-header">
					...
					<div class="major-publishing-actions wp-clearfix">
						<div class="publishing-action">
							...
							<?php if ( isset( $new_preview ) ) {
															?>
								<a href="<?php echo esc_url( ($new_preview) ); ?>" rel="noreferrer noopener" target="_blank" class="button button-secondary button-large" title="<?php esc_attr_e( 'Preview Form', 'user-registration' ); ?>"><?php esc_html_e( 'Preview', 'user-registration' ); ?></a>
							<?php } ?>
