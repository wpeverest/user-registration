				...
				<div id="nav-menu-header">
					<div class="major-publishing-actions wp-clearfix">
						...
						if ( isset( $post_data[0] ) ) {
							...
							?>
							<input type="text" onfocus="this.select();" readonly="readonly" value='[user_registration_form id=<?php echo '"'.$post_data[0]->ID.'"' ?>]' class=" code" size="35">
							...
							<nav class="nav-tab-wrapper ur-tabs">
								<ul class="ur-tab-lists">
									<li><a href="#ur-tab-registered-fields"
										   class="nav-tab active"><?php esc_html_e( 'Fields' ,'user-registration' ) ?></a></li>
									<li class="ur-no-pointer"><a href="#ur-tab-field-options"
										   class="nav-tab"><?php esc_html_e( 'Field Options','user-registration' ) ?></a></li>
								</ul>
