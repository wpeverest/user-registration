		...
		<div id="menu-management">
			<div class="menu-edit">
				...
				<?php if ( isset( $preview_link ) ) { ?>
					...
					<?php } ?>
					<?php lg( $_GET ); ?>
					<button name="embed_form" data-form_id="<?php echo esc_html( isset( $_GET['edit-registration'] ) ? absint( sanitize_text_field( wp_unslash( $_GET['edit-registration'] ) ) ) : 0 ); ?>" class="button button-secondary button-large ur-embed-form-button" type="button" value="<?php esc_attr_e( 'Embed', 'user-registration' ); ?>"><?php esc_html_e( 'Embed', 'user-registration' ); ?></button>
