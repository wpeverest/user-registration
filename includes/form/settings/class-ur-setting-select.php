...
class UR_Setting_Select extends UR_Field_Settings {
	...
	/**
	 * UR_Setting_Select Class Constructor.
	 */
	...
	public function register_fields() {
		...
		/**
		 * Filter to modify the select custom advance settings.
		 *
		 ...
		 */
		$fields = apply_filters( 'select_custom_advance_settings', $fields, $this->field_id, $this->default_class );
