...
class UR_Setting_User_confirm_password extends UR_Field_Settings {
	...
	/**
	 * UR_Setting_User_confirm_password Class Constructor.
	 */
	...
	public function register_fields() {
		...
		/**
		 * Filter to modify the user confirm password custom advance settings.
		 *
		 ...
		 */
		$fields = apply_filters( 'user_confirm_password_custom_advance_settings', $fields, $this->field_id, $this->default_class );
