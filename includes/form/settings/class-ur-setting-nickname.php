	...
	public function register_fields() {
		$fields = array(
			...
			'limit_length_limit_count'   => array(
				...
				'type'        => 'number',
				'required'    => false,
				'default'     => apply_filters( 'user_registration_nickname_default_limit_length', 50 ),
				'placeholder' => '',
			...
			'limit_length_limit_mode'    => array(
				...
				'required'    => false,
				'default'     => apply_filters( 'user_registration_nickname_default_limit_mode', 'characters' ),
				'placeholder' => '',
