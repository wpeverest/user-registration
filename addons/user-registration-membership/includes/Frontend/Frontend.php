...
class Frontend {
	...
	public function load_scripts() {
		...
		wp_register_script( 'user-registration-membership-frontend-script', UR_MEMBERSHIP_ASSETS_URL . '/js/frontend/user-registration-membership-frontend' . $suffix . '.js', array( 'jquery' ), '1.0.0', true );
		wp_enqueue_script( 'user-registration-membership-frontend-script' );
		// Enqueue frontend styles here.
		wp_register_style( 'user-registration-membership-frontend-style', UR_MEMBERSHIP_ASSETS_URL . '/css/user-registration-membership-frontend.css', array(), UR_MEMBERSHIP_VERSION );
